...
--
-- Table structure for table `jobai_app_company_type_master`
--

DROP TABLE IF EXISTS `jobai_app_company_type_master`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `jobai_app_company_type_master` (
...
--
-- Dumping data for table `jobai_app_company_type_master`
--
...
-- Dump completed on 2025-03-23  8:27:06
